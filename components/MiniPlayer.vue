  ...
  <div
    ...
    <div class="grid grid-cols-5 w-full justify-between items-center overflow-hidden">
      <div class="col-span-2 flex w-full">
        <template v-if="true">
          <div class="relative rounded-md overflow-hidden cursor-pointer w-14" @click="() => playerModeToggle()">
            ...
            <div class="absolute w-full h-full top-0 flex flex-col items-center justify-center cursor-pointer">
              <Icon class=" relative top-[1px]" :name="!playerMode ? 'ri:arrow-up-s-line' : 'ri:arrow-down-s-line'"
                size="22" />
              <Icon class=" relative bottom-[1px]" :name="!playerMode ? 'ri:arrow-down-s-line' : 'ri:arrow-up-s-line'"
                size="22" />
            </div>
          </div>
...
const { likeToggle, pauseToggle, playerModeToggle } = player
const { playerMode, pause, like, playmode, playmodeIcon } = storeToRefs(player)
</script>