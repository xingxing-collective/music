<template>
  ...
  >
    <div
      class="hidden md:grid lg:grid grid-cols-5 w-full justify-between items-center overflow-hidden"
    >
      <div class="col-span-2 flex w-full">
        <template v-if="currentSongUrl && currentSongDetail">
          ...
          >
            ...
            <NuxtImg
              class="blur-sm w-full h-full"
              lazy="loaded"
              :src="`${currentSongDetail?.al.picUrl}?param=80y80`"
            />
            <div
              class="absolute w-full h-full top-0 flex flex-col items-center justify-center cursor-pointer"
            >
              <Icon
          ...
          <div class="flex flex-col w-full pl-2">
            <div class="flex h-1/2 items-center gap-[2px]">
              ...
              <div class="text-[0.75rem] text-[--text-color]">
