<template>
  <div class="py-4 w-full flex flex-col gap-4">
    <div v-if="hotComments?.length">
      ...
      <CommentsItem
        class="border-b dark:border-[rgb(63,63,63)] border-[rgb(242,242,242)]"
    ...
    <div v-if="comments?.length">
      ...
      <CommentsItem
        :class="[
          index + 1 === comments?.length ? 'border-none' : 'border-b',
          'dark:border-[rgb(63,63,63)] border-[rgb(242,242,242)]',
        ]"
...
const hotComments = shallowRef<Comment[]>();
